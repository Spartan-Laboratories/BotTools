...
public class BotListener extends ListenerAdapter {
	...
	public void onPrivateMessageReceived(PrivateMessageReceivedEvent event){
		if(!event.getAuthor().isBot())
			System.out.println(event.getAuthor() + " says: " + event.getMessage().getContentRaw());	
	}
	@Override
	...
	*/
	...
	private void performSpamHandling(GuildMessageReceivedEvent event){
	...
	public void ignoreChannel(TextChannel channel) {
		ignoredChannels.add(channel);
	}
	public void unignoreChannel(TextChannel channel) {
	...
	private boolean isSpam() {
		return Botmain.guildManager.spamDetection((GuildMessageReceivedEvent)messageEvent);
	}
